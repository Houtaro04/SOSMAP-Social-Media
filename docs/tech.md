...
- **Lucide Icons**: Bộ icon tinh tế, đồng nhất và có hiệu năng tốt cho giao diện người dùng.
...
- **Microsoft SignalR**: Công cụ hỗ trợ giao tiếp theo thời gian thực (Real-time) cho tính năng nhắn tin (Chat).
